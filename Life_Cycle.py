...
# This simply just displays the prompt of my alien friend and their introduction
 ...
 # The user is required to enter the age, depending on answer one of two responses will come.   
    ...
    print()
    print()
# There is only one response for this after the user inputs the sex
    ...
    print()
# The height has only one response
    ...
    if Fitness_level >= 3:
        ...
        print()
         ...
         print()
# fitness level gives us a couple responses depending if they're greater than 3
    ...
    if DRINK == "Yes":
         ...
         print('I know a guy that can help with that')
          ...
          print()
# depending on the users answers this prompt will decide whether you get ate alive or told to leave
